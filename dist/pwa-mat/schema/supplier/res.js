...
var resolvers = {
  RootQuery: {
    listSupplier: function () {
      ...
      function listSupplier(_x, _x2, _x3) {
  ...
  RootMutation: {
    deleteSupplier: function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                (0, _util._auth)(authUser);
                _context2.next = 3;
                return _models.Supplier.destroy({
                  where: {
                    id: {
                      $in: input
                    }
      ...
      function deleteSupplier(_x4, _x5, _x6) {
    ...
    updateSupplier: function () {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                (0, _util._auth)(authUser);
                _context3.next = 3;
                return _models.Supplier.upsert(input).then(function () {
                  return input;
                });
      ...
      function updateSupplier(_x7, _x8, _x9) {
